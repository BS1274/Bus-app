...
const Home_Page = (props) => {
  ...
  const cardDetails = [
    ...
    },
    {
      ...
      imageURL: "https://media.licdn.com/dms/image/C4D12AQGaZr-LdSpEDQ/article-cover_image-shrink_600_2000/0/1652620461357?e=2147483647&v=beta&t=1_dV_gbSnmDhUaer7yKbU4oF4WLes2h5Phl0eyyi4ng",
    },
    {
      title: "5000+",
  ...
  return (
    <div>
      <div
        className="bg-cover bg-center h-[110vh]"
