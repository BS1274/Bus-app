  ...
  return (
    <footer className="text-center lg:text-left bg-gray-300 text-gray-600">
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid grid-1 lg:grid-cols-5 gap-8">
          ...
          "
            ...
            <p>When you have a choice. Choose Reserve Bus</p>
            <p className="py-2">
              Reserve Bus offers bus tickets booking through its website,ios and
              android mobile apps for all major cities.
            </p>
            <p className="py-2">www.reservebus.com</p>
          </div>
          <div></div>
          <div className="">
      ...
      <div className="text-center p-6 bg-gray-300">
        ...
        >
          Made By BS and currently in working progress of this app
        </a>
      </div>
    </footer>
  );
